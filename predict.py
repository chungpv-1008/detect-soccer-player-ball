...
class Predictor:
    ...
    def predict_video(self, video_path):
        ...
        saver = cv2.VideoWriter(video_path[:-4] + '-output.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'),
...
if __name__ == "__main__":
    ...
    if args.video:
        video_path = 'demo/messi.mp4'
        predictor.predict_video('demo/messi.mp4')
