...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str,
                        default='pretrained_weights/yolov5x.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/my_yolo.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str,
                        default='datasets/dataset.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str,
                        default='data/hyps/hyp.scratch.yaml', help='hyperparameters path')
...
def main(opt):
    ...
    if not opt.evolve:
        ...
        if WORLD_SIZE > 1 and RANK == 0:
            _ = [print('Destroying process group... ', end=''),
